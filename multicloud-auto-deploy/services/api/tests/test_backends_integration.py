...
class TestGcpBackend(TestBackendBase):
    ...
    def get_backend(self):
        ...
        with (
            patch('app.backends.gcp_backend._get_firestore') as mock_get_firestore,
            patch('app.backends.gcp_backend._get_storage') as mock_get_storage,
...
class TestAzureBackend(TestBackendBase):
    ...
    def get_backend(self):
        ...
        with (
            patch('app.backends.azure_backend._get_container') as mock_get_container,
            patch('app.backends.azure_backend._get_blob_service') as mock_get_blob,
