...
%\usepackage{lmodern} % disabled - not installed
$endif$
...
$endif$
$if(strikeout)$
$-- soul.sty not available; strikeout handled by ulem alternative
\newcommand{\st}[1]{\textit{#1}} % fallback: italics instead of strikeout
$endif$
...
\usepackage{csquotes}
$endif$
% bookmark.sty disabled (requires pzdr font not available)
\usepackage{hyperref}
% Override XeTeXLink@font to avoid missing pzdr (ZapfDingbats) font
\makeatletter
