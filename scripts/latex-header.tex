...
% Better font setup for CJK (fontspec only, no xeCJK/ctex required)
% Use Noto CJK fonts for both Japanese and Latin text
...
% Better link colors (hyperref loaded later by pandoc template, use AtBeginDocument)
\AtBeginDocument{
\hypersetup{
    colorlinks=true,
...
% Set default image size for diagrams (Mermaid charts)
% Icons will be explicitly sized smaller via Pandoc attributes
