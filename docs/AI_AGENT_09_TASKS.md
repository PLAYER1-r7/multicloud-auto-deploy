...
| 6   | **Enable Azure WAF**                             | WAF policy not applied to Front Door Standard SKU. Repository policy prohibits Premium SKU, so create and attach a Standard SKU-compatible WAF Policy.                                                                    | [08_SECURITY](AI_AGENT_08_SECURITY.md)                                       |
