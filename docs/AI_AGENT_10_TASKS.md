...
| 3   | **~~Confirm DynamoDB `PostIdIndex` GSI~~** ✅ | GSI confirmed. `GET /posts/{id}` implemented and working (2026-02-22). | [RB-09](AI_AGENT_08_RUNBOOKS.md#rb-09-verify--create-the-dynamodb-postidindex-gsi) |
