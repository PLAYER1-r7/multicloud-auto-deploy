...
> **Purpose**: Consolidated index of all known bugs and their fixes across all three cloud environments.
> Reference this document when debugging recurring issues or before deploying changes.

---

## Overview

| Date       | Report                                                                              | Cloud         | # Bugs  | Status       |
| ---------- | ----------------------------------------------------------------------------------- | ------------- | ------- | ------------ |
...
1. [AWS SNS Fix (2026-02-20)](#1-aws-sns-fix-report-2026-02-20)
2. [AWS Production HTTPS Fix (2026-02-21)](#2-aws-production-https-fix-2026-02-21)
3. [AWS Production SNS Fix (2026-02-21)](#3-aws-production-sns-fix-2026-02-21)
4. [React SPA Migration & CDN Routing Fix (2026-02-21)](#4-react-spa-migration--cdn-routing-fix-2026-02-21)
5. [Azure SNS Fix (2026-02-21)](#5-azure-sns-fix-2026-02-21)
6. [AWS SNS Fix 12 bugs (2026-02-22)](#6-aws-sns-fix-report-2026-02-22)
7. [AWS + Azure Combined SNS Fix (2026-02-22)](#7-aws--azure-combined-sns-fix-2026-02-22)
8. [Refactoring & Infrastructure Fix (2026-02-22)](#8-refactoring--infrastructure-fix-2026-02-22)
9. [GCP SNS Fix (2026-02-23)](#9-gcp-sns-fix-report-2026-02-23)
10. [OCR Formula Merge Bugs (2026-02-27)](#10-ocr-formula-merge-bugs-2026-02-27)

---

## 1. AWS SNS Fix Report (2026-02-20)
